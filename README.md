...
本页面内帐号密码和一键配置的链接皆为测试帐号，有效期一小时，随时更新。用测试帐号翻墙之后可以访问我们的[主页](https://www.logmian.com)登录并获得正式帐号。
